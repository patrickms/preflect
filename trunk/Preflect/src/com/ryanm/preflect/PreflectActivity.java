...
public class PreflectActivity extends PreferenceActivity
{
	...
	private Dialog buildSaveDialog()
	{
		...
		final String[] saves = Persist.listSaves( PreflectActivity.this, returnTo );
		adb.setItems( saves, new OnClickListener() {
			@Override
			public void onClick( DialogInterface dialog, int which )
			{
				Persist.save( PreflectActivity.this, returnTo, saves[ which ], json );
			}
		} );
	...
	private Dialog buildNewNameDialog()
	{
		...
		adb.setPositiveButton( "Save", new DialogInterface.OnClickListener() {
			...
			public void onClick( DialogInterface dialog, int whichButton )
			{
				...
				Persist.save( PreflectActivity.this, returnTo, savename, json );
			}
		} );
	...
	private Dialog buildLoadDialog()
	{
		...
		adb.setItems( saves, new OnClickListener() {
			...
			{
				JSONObject loaded =
						Persist.load( PreflectActivity.this, returnTo, saves[ which ] );
				if( loaded != null )
				{
				...
				{
					Toast.makeText( PreflectActivity.this,
		...
		adb.setPositiveButton( "Delete", new OnClickListener() {
			...
			public void onClick( DialogInterface dialog, int which )
			{
				for( int i = 0; i < saves.length; i++ )
				{
					if( delete[ i ] )
					{
						Persist.deleteSave( PreflectActivity.this, returnTo, saves[ i ] );
					}
				}
			}
		} );
